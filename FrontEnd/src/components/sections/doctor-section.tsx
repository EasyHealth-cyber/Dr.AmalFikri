    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* Info */}
          <div className="flex flex-col justify-center space-y-6 text-left md:text-left relative">
            <h2 className="text-3xl md:text-4xl font-extrabold text-foreground mb-4">
              Médecin psychiatre & addictologue
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Passionnée par la santé mentale et le bien-être, j’accompagne mes
              patients avec expertise et bienveillance dans la compréhension et
              la prise en charge de leurs troubles psychiques et des conduites
              addictives.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <ul className="list-disc list-inside text-lg text-muted-foreground leading-relaxed space-y-2">
              <li>
                Évaluation psychique complète : diagnostic et suivi des troubles
                psychiatriques.
              </li>
              <li>
                Aide au sevrage : accompagnement médical et psychothérapeutique
                pour la réduction ou l’arrêt de substances.
              </li>
              <li>
                Prise en charge personnalisée : traitements médicamenteux adaptés
                et suivi régulier.
              </li>
              <li>
                Psychothérapie individuelle : soutien émotionnel et
                développement personnel.
              </li>
              <li>
                Thérapie de couple : améliorer la communication, résoudre les
                conflits et renforcer la relation.
              </li>
            </ul>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Ma pratique est basée sur une approche humaine, confidentielle et
              centrée sur le patient, avec un suivi adapté aux besoins de chacun.
            </p>
